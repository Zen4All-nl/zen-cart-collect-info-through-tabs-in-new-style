...
define('PRODUCT_FIELDS', DIR_WS_MODULES . 'product_fields/'); 
define('PRODUCT_FIELDS_INCLUDES_SQL_FOLDER', PRODUCT_FIELDS . 'sql/');
define('INCLUDES_TEMPLATES_FOLDER', PRODUCT_FIELDS . 'templates/');
define('INCLUDES_HTML_OUTPUT_FOLDER', PRODUCT_FIELDS . 'html_output/');
define('INCLUDES_SQL_ARRAY_FOLDER', PRODUCT_FIELDS . 'sql_array/');
define('CITTINS_REPOSITORY_NAME', 'Collect-Info-Through-Tabs-In-New-Style-for-Zen-Cart');
