                                                ...
                                                foreach ($tabArray as $i => $tab) {
                                                    ...
                                                    <tr id="<?php echo $tab['id']; ?>" class="ui-state-default" role="button">
                                                        <td class="sortOrder" style="vertical-align: middle">
                                                            ...
                                                            <?php
                                                            echo zen_draw_hidden_field('tabSort[' . $i . '][sort_order]', $tab['sortOrder'], 'class="sortOrderValue"');
                                                            echo zen_draw_hidden_field('tabSort[' . $i . '][id]', $tab['id']);
                                                            ?>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td class="text-right">
                                                            <?php
                                                            echo zen_draw_hidden_field('tab_id', $tab['id']);
                                                            echo zen_html_button('', '<i class="fa fa-pencil fa-lg"></i>', 'primary', ' id="button-edit-tab-' . $tab['id'] . '" data-toggle="modal" data-target="#TabEditModal" title="' . IMAGE_EDIT . '" onclick="editTab(' . $tab['id'] . ');" ' . ($tab['core'] == '1' ? 'disabled' : ''));
                                                            echo zen_html_button('', '<i class="fa fa-trash fa-lg"></i>', 'warning', ' id="button-delete-tab-' . $tab['id'] . '" data-toggle="modal" data-target="#TabDeleteModal" title="' . IMAGE_DELETE . '" onclick="deleteTab(' . $tab['id'] . ');" ' . ($tab['core'] == '1' || in_array($tab['id'], $tabIsInUseArray) || $tab['productType'] != '' ? 'disabled' : ''));
                                                            echo zen_html_button('', '<i class="fa fa-info fa-lg"></i>', 'info', ' id="button-info-tab-' . $tab['id'] . '" data-toggle="modal" data-target="#TabInfoModal" title="' . ICON_INFO . '" onclick="tabInfo(' . $tab['id'] . ');"');
                                                            ?>
                                                        </td>
                                                    </tr>
                                            ...
                                            <?php foreach ($availableTabsArray as $tab) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <?php
                                                        echo zen_draw_hidden_field('tab_id', $tab['id']);
                                                        echo zen_html_button('', '<i class="fa fa-trash-o fa-lg" aria-hidden="true"></i>', 'warning', 'title="' . IMAGE_DELETE . '" ' . ($tab['core'] == '1' || in_array($tab['id'], $tabIsInUseArray) || $tab['productType'] != '' ? 'disabled' : ''));
                                                        if ($tab['core'] == '1' || in_array($tab['id'], $tabIsInUseArray) || $tab['productType'] != '') {
                                                            echo zen_html_button('submit', '<i class="fa fa-info"></i>', 'info', 'onclick="getDeleteTabInfo(' . $tab['id'] . ')" data-toggle="modal" data-target="#DeleteTabInfoModal"');
                                                        }
                                                        ?>
                                                    </td>
                                                </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="floatButton">
                                                        <?php echo zen_html_button('submit', IMAGE_SAVE, 'primary', ''); ?> <a href="<?php echo zen_href_link(FILENAME_CITTINS_PRODUCT_LAYOUT_EDITOR); ?>" class="btn btn-default" role="button">Reset</a>
                                                    </div>
