        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
              ...
              <?php echo zen_draw_input_field('price_prefix', '', 'size="2" class="form-control" id="price_prefix"'); ?>
            </div>
            <div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
            ...
            <div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
              ...
              <?php echo zen_draw_input_field('products_attributes_weight_prefix', '', 'size="2" class="form-control" id="products_attributes_weight_prefix"'); ?>
            </div>
            <div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
          ...
          <div class="row row-eq-height" id="attributeFlags">
            ...
            <div class="col-sm-2 pt-5 pb-5 text-center" style="background-color: #ffa346;">
              <p class="control-label"><?php echo TEXT_ATTRIBUTES_DEFAULT; ?></p>
              <div class="input-group" style="display: block;">
                <div class="radioBtn btn-group">
          ...
          <?php if (ATTRIBUTES_ENABLED_IMAGES == 'true') { ?>
            ...
            <div id="attributeImage">
              ...
              <div class="row">&nbsp;</div>
              <div class="row">
                <div class="col-sm-6"><?php echo zen_draw_label(TEXT_ATTRIBUTES_IMAGE_DIR, 'img_dir', 'class="control-label"') . zen_draw_pull_down_menu('img_dir', $attributeDirInfo, $attributeDefaultDirectory, 'class="form-control"'); ?></div>
                ...
                <div class="col-xs-6 col-sm-3">
                  <p class="control-label"><?php echo TEXT_IMAGES_DELETE; ?></p>
                  <div class="input-group">
                    <div class="radioBtn btn-group">
