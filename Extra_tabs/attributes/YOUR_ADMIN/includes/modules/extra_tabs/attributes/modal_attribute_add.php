        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
              ...
              <?php echo zen_draw_input_field('default_price_prefix', $defaultPricePrefixResult, 'size="2" class="form-control" id="default_price_prefix"'); ?>
            </div>
            <div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
              <?php echo zen_draw_label(TABLE_HEADING_OPT_PRICE, 'value_price', 'class="control-label"'); ?>
              <?php echo zen_draw_input_field('value_price', '', 'size="6" class="form-control" id="value_price"'); ?>
            </div>
            <div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
              <?php echo zen_draw_label(TABLE_HEADING_OPT_WEIGHT, 'default_weight_prefix', 'class="control-label"'); ?>
              <?php echo zen_draw_input_field('default_weight_prefix', $defaultWeightPrefixResult, 'size="2" class="form-control" id="default_weight_prefix"'); ?>
            </div>
            <div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
              <?php echo zen_draw_label(TABLE_HEADING_OPT_WEIGHT, 'products_attributes_weight', 'class="control-label"'); ?>
              <?php echo zen_draw_input_field('products_attributes_weight', '', 'size="6" class="form-control" id="products_attributes_weight"'); ?>
            </div>
            <div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
          ...
          <?php if (ATTRIBUTES_ENABLED_QTY_PRICES == 'true') { ?>
            <div class="row">
              <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
                ...
                <?php echo zen_draw_input_field('attributes_qty_prices', '', 'class="form-control" id="attributes_qty_prices"'); ?>
              </div>
              <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
                <?php echo zen_draw_label(TABLE_HEADING_ATTRIBUTES_QTY_PRICES_ONETIME, 'attributes_qty_prices_onetime', 'class="control-label"'); ?>
                <?php echo zen_draw_input_field('attributes_qty_prices_onetime', '', 'class="form-control" id="attributes_qty_prices_onetime"'); ?>
              </div>
            </div>
            <hr style="border: 1px solid #ccc; margin: 10px 0;">
          <?php } ?>
          ...
          <div class="row row-eq-height" id="addAttributeFlags">
            <div class="col-sm-2 pt-5 pb-5 text-center" style="background-color: #ff0">
              <p class="control-label"><?php echo TEXT_ATTRIBUTES_DISPLAY_ONLY; ?></p>
            ...
            <div class="col-sm-2 pt-5 pb-5 text-center" style="background-color: #2c54f5;">
              <p class="control-label"><?php echo TEXT_ATTRIBUTES_IS_FREE; ?></p>
              <div class="input-group" style="display: block;">
                <div class="radioBtn btn-group">
            ...
            <div class="col-sm-2 pt-5 pb-5 text-center" style="background-color: #ffa346;">
              <p class="control-label"><strong><?php echo TEXT_ATTRIBUTES_DEFAULT; ?></strong></p>
              <div class="input-group" style="display: block;">
                <div class="radioBtn btn-group">
            ...
            <div class="col-sm-2 pt-5 pb-5 text-center" style="background-color: #f0f;">
              <p class="control-label"><?php echo TEXT_ATTRIBUTE_IS_DISCOUNTED; ?></p>
              <div class="input-group" style="display: block;">
                <div class="radioBtn btn-group">
            ...
            <div class="col-sm-2 pt-5 pb-5 text-center" style="background-color: #d200f0;">
              <p class="control-label"><?php echo TEXT_ATTRIBUTE_PRICE_BASE_INCLUDED; ?></p>
              <div class="input-group" style="display: block;">
                <div class="radioBtn btn-group">
            ...
            <div class="col-sm-2 pt-5 pb-5 text-center" style="background-color: #FF0606">
              <p class="control-label"><?php echo TEXT_ATTRIBUTES_REQUIRED; ?></p>
              <div class="input-group" style="display: block;">
                <div class="radioBtn btn-group">
          ...
          <?php if (DOWNLOAD_ENABLED == 'true') { ?>
            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                ...
                <?php echo zen_draw_input_field('products_attributes_maxdays', DOWNLOAD_MAX_DAYS, 'size="5" class="form-control" id="products_attributes_maxdays"'); ?>
              </div>
              <div class="col-sm-4">
                <?php echo zen_draw_label(TABLE_TEXT_MAX_COUNT, 'products_attributes_maxcount', 'class="control-label"'); ?>
                <?php echo zen_draw_input_field('products_attributes_maxcount', DOWNLOAD_MAX_COUNT, 'size="5" class="form-control" id="products_attributes_maxcount"'); ?>
              </div>
            </div>
          <?php } ?>
        </div>
